...
########################################################
# função de estatísticas descritivas/qualidade dos dados
########################################################
...
# salva os três resultados finais em disco: dados limpos, resumo anual e metadados
def exportar_resultados(df, resumo_anual, metadados, pasta_saida):
...
def organizar_dados_bdmep(caminho_arquivo_bruto):
    ...
    exportar_resultados(df, resumo_anual, metadados, pasta_do_arquivo + "/output")
 
    return df, resumo_anual, metadados
